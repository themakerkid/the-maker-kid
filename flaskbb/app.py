...
from flaskbb.stem.views import stem
# models
from flaskbb.user.models import User, Guest
# extensions
from flaskbb.extensions import (bootstrap, db, login_manager, mail, cache, redis_store,
...
def configure_blueprints(app):
    app.register_blueprint(stem, url_prfix=app.config["STEM_URL_PREFIX"])
